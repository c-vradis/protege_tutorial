...
Για να δηλώσουμε ότι το νέο και εξωτερικό individual είναι ταυτόσημο με το individual του Χαροκοπείου Πανεπιστημίου που έχουμε προσθέσει ήδη στην οντολογία μας, χρησιμοποιούμε την επιλογή **"Same individual as"** και επιλέγουμε το 
